...
这是一套专为 Claude 设计的 Agent Skills，把柯维七个习惯的思考框架拆分成 9 个独立、可组合的子技能。你可以把它们当作**不同视角的"原则性审阅官"**——当你已经有了人生宣言、长期规划或周计划，让 Claude 扮演柯维的角色审视你的规划体系，发现断层、盲点和偏离。

> **v2.1.0 版本更新：** 全套 SKILL.md 依据《高效能人士的七个习惯》（20 周年纪念版，高新勇译）完整 OCR 后重写；
> 新增 `life-center-diagnosis`（基于附录一"生活中心面面观"）作为使命宣言的前置诊断；
> `quadrant-ii-time-management` 吸收附录二"第四代时间管理"，加入按角色的周计划与一日样板模板；
> 把**产出 / 产能平衡（P/PC Balance）**和**成熟度连续体**作为贯穿框架嵌入 `sharpen-the-saw`、`quadrant-ii`、`stephen-covey`；
> `stephen-covey` 调度逻辑从"触发词→子技能"改为"**先诊断（成熟度 + 生活中心）→ 再调度**"；
> 整体语气靠近原著导师谈心风格，每个子技能结尾新增"付诸行动"作业模板。
...
├── stephen-covey/                      # 主人格 + 子技能调度（先诊断后调度）
├── circle-of-influence/                # 习惯 1 · 积极主动
├── life-center-diagnosis/              # 习惯 2 前置 · 生活中心诊断（新增）
├── personal-mission-statement/         # 习惯 2 · 以终为始
├── quadrant-ii-time-management/        # 习惯 3 · 要事第一（含第四代时间管理）
├── win-win-agreement/                  # 习惯 4 · 双赢思维（含统合综效）
├── seek-first-to-understand/           # 习惯 5 · 知彼解己
├── emotional-bank-account/             # 习惯 4-6 基础 · 信任管理
└── sharpen-the-saw/                    # 习惯 7 · 自我更新(含 P/PC 平衡)
```
...
| 子技能 | 对应习惯 | 核心用途 |
|--------|---------|---------|
| **stephen-covey** | 总控 | 先做成熟度 + 生活中心快诊断，再调度子技能 |
| **circle-of-influence** | 习惯 1 | 把精力从"关注圈"拉回"影响圈"；语言诊断 |
| **life-center-diagnosis** | 习惯 2 前置 | 识别当下 10 种生活中心中的锚点，引向原则中心 |
| **personal-mission-statement** | 习惯 2 | 建立/审视人生宣言（四种需求 + 遗产可视化） |
| **quadrant-ii-time-management** | 习惯 3 | 四代时间管理演进 + 按角色的周计划 + 一日样板 |
| **win-win-agreement** | 习惯 4 | 六种互动范式 + 双赢协议五要素 + 统合综效第三条路 |
| **seek-first-to-understand** | 习惯 5 | 移情倾听四阶段，破除自传式回应 |
| **emotional-bank-account** | 习惯 4-6 | 六类存款/取款，关系信任诊断与修复 |
| **sharpen-the-saw** | 习惯 7 | 四维度 P/PC 诊断，每日私下胜利 |
...
| **每月第一天** | 当月进展 vs 1 年规划 | 1 小时 | `personal-mission-statement` + `quadrant-ii` |
| **每季末** | 季度复盘 + 下季规划 | 2 小时 | 全套 |
| **每年 12 月** | 5 年规划调整 / 使命宣言更新 | 半天 | `life-center-diagnosis` + `personal-mission-statement` + `sharpen-the-saw` |

> **v2.1 重要变化：** 每年/重大人生转折前的 Review，建议**先**跑一次 `life-center-diagnosis`——
> 看清自己当下真正被什么锚定，再去改使命宣言，避免把现有中心美化成宣言。
...
### 模式 D：成熟度 + 生活中心诊断（v2.1 新增）

**用于：** 年度回顾 / 重大人生抉择前 / 反复为同一类事情痛苦时

**做什么：** 在改使命宣言、做长期决策之前，先判断自己当下卡在依赖→独立→互赖哪一段，
以及当下被十种生活中心中的哪一种/几种锚定。

**提示词模板：**

```
我在 [情境描述] 里反复痛苦/卡住。
请先用 life-center-diagnosis 帮我做一次生活中心诊断：

1. 我目前的"安全感 / 指引 / 智慧 / 力量"主要来自哪里？
2. 我主要落在 10 种生活中心（配偶/家庭/金钱/工作/财富/享乐/朋友/敌人/宗教/自我）的哪几种？
3. 每种中心的稳定性如何？
4. 如果要向"原则中心"迁移，具体要放下什么、建立什么？

诊断之后，再决定是否调用 personal-mission-statement 做宣言重写。
```
...
- **新增 `life-center-diagnosis`** —— 基于附录一"生活中心面面观"，作为使命宣言前置
- **`quadrant-ii-time-management` 扩写** —— 加入第四代时间管理演进、按角色的周计划模板、附录二"一日样板"
- **嵌入 P/PC 平衡** —— 进 `sharpen-the-saw` 和 `quadrant-ii`，作为 Q2 重要性的底层解释
- **嵌入成熟度连续体作为诊断工具** —— 进 `stephen-covey`，帮助快速识别用户所处阶段
- **调度逻辑升级** —— `stephen-covey` 从"触发词→子技能"改为"**先诊断（成熟度+生活中心+规划完整度）→ 再调度**"
- **语气整体向原著导师风格靠近** —— 引用多处原著原文与比喻（会下金蛋的鹅、伐木工与锯子、眼科医生的药方）
- **每个子技能结尾新增"付诸行动"作业** —— 借鉴原著每章末尾的练习结构
